...
1. **Phase 2 완료** — `infra/phase2/deploy.sh` 통과 + repo root `.env` 채워진 상태 (`DEMO_USER`, `GATEWAY_ID`, `AWS_REGION` 등).
...
`runbooks/` 디렉토리 read 권한이 필요. https://github.com/settings/tokens 에서 발급:
