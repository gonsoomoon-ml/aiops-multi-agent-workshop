...
A2A — Cognito Client C Bearer JWT 필요 (Phase 2 재사용 — Option X). Supervisor `@tool call_monitor_a2a` 가 자동 호출. 단독 디버깅은 Phase 6a Step D 의 Operator CLI 또는 `a2a-sdk` client 코드로.
